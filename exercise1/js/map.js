...
const svg = d3.select("svg"),
	...
	worldpopulation = "https://raw.githubusercontent.com/galaxie500/UCSD-MAS-DSE241/main/exercise1/for_map.csv";
...
function ready(error, topo) {
	...
	let mouseOver = function(d) {
		...
		tooltip.style("left", (d3.event.pageX + 15) + "px")
			...
			.style("opacity", 1)
			.text(d.properties.name + ': ' + d.total  + ' medals');
	}
	...
	legend_entry.append("text")
		...
		.text(function(d, i) {
			if (i === 0) return "< " + d[1] + " medals";
			if (d[1] < d[0]) return d[0] + " medals +";
			return d[0] + "  - " + d[1] + " medals";
		});

	legend.append("text").attr("x", 15).attr("y", 280).text("Total Medals");
}
